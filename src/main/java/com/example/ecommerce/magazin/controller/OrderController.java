...
import com.example.ecommerce.magazin.service.OrderService;
...
public class OrderController {
    ...
    @PatchMapping("/order/cencel/{id}")
    public ResponseEntity<OrderMain> cencel(@PathVariable("id") Long orderId,
                                            Authentication authentication){
        ...
        return ResponseEntity.ok(orderService.cencel(orderId));
    }
