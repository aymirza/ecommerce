package com.example.ecommerce.magazin.security;

import com.example.ecommerce.magazin.security.JWT.JwtEntryPoint;
import com.example.ecommerce.magazin.security.JWT.JwtFilter;
...
public class SpringSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Value("${string.queries.users-query}")
